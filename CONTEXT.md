...
- a sincronizacao agora aceita `codigoMunicipio` vindo do proprio endereco salvo ou, em contingencia segura, do `providerData.endereco.municipio.codigo_ibge`; se ambos estiverem ausentes, tenta resolver o codigo pelo par `cidade + UF` via IBGE antes de bloquear a sincronizacao
